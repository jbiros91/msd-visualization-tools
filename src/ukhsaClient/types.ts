...
export type PaginatedAPITimeSeriesListList = components['schemas']['PaginatedAPITimeSeriesListList']
export type APITimeSeriesList = components["schemas"]["APITimeSeriesList"]
export type Pagination = { page: number, pageSize: number }
export type PaginatedMetricFn = (pagination: Pagination) => Promise<PaginatedAPITimeSeriesListList | null>
