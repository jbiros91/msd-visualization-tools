'use client'
import { Layout, Card, Space, Row, Col, Avatar, Button } from 'antd'
import {
    DownloadOutlined,
    FilterOutlined,
                        ...
                        >
                            <Card
                                ...
                                actions={[
                                    ...
                                    />,
                                    <FavoriteButton
                                        key={ChartId.COVID_19_DEATHS_BY_DAY}
                                        chartId={ChartId.COVID_19_DEATHS_BY_DAY}
                                    />,
                                    <Button
                                        key={`${ChartId.COVID_19_DEATHS_BY_DAY}-comment`}
                                        type='link'
                                        size='small'
                                        icon={
                                            <CommentOutlined
                        ...
                        >
                            <Card
                                ...
                                actions={[
                                    ...
                                    />,
                                    <FavoriteButton
                                        key={ChartId.COVID_19_ADMISSION_BY_DAY}
                                        chartId={
                                            ChartId.COVID_19_ADMISSION_BY_DAY
                                        }
                                    />,
                                    <Button
                                        key={`${ChartId.COVID_19_ADMISSION_BY_DAY}-comment`}
                                        type='link'
                                        size='small'
                                        icon={
                                            <CommentOutlined
